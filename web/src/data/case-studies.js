...
export const caseStudies = [
  ...
  { slug: 'los-angeles-detection-reentry-2024', img: '/assets/case-la-urban.jpg', name: 'Near-Surface Detection, Mill & Re-Enter', location: 'Los Angeles, California, USA', year: '2024', region: 'United States', featured: false, scope: ['Well Intervention', 'Plug & Abandonment'], meta: { ranging: 'AMR + PMR', deployment: 'While Drilling (PMR) / Wireline (AMR)', reentry: 'Yes' } },
